...
class GiveawayResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'starts_at' => optional($giveaway->starts_at)?->format('Y-m-d\TH:i'),
            'ends_at' => optional($giveaway->ends_at)?->format('Y-m-d\TH:i'),
            ...
            'participants' => $giveaway->participants->map(fn ($participant) => [
                ...
                'joined_at' => optional($participant->joined_at)?->format('d.m.Y H:i'),
            ...
            'winners' => $giveaway->winners->map(fn ($winner) => [
                ...
                'selected_at' => optional($winner->selected_at)?->format('d.m.Y H:i'),
            ])->values()->all(),
            'links' => [
